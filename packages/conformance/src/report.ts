//
// TypeScript mirror of spec/ir/corpus/report.schema.json in finos/morphir.
// Keep the two in step: the schema is the contract other languages validate
// against; these types are what the driver writes.

export type ReportResult = "pass" | "fail" | "corpus-error" | "skipped";
...
export function emptyReport(header: Pick<Report, "binding" | "language" | "driverVersion" | "corpusVersion">): Report {
